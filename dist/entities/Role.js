...
__decorate([
    (0, typeorm_1.Column)({ type: "int", default: permissions_1.RoleLevel.MEMBER }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Organization_1.Organization, (organization) => organization.roles, { nullable: true, onDelete: "CASCADE" }),
